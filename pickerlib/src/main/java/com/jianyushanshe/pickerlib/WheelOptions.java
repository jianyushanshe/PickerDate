...
import com.jianyushanshe.pickerlib.adapter.ArrayWheelAdapter;
import com.jianyushanshe.pickerlib.lib.WheelView;
import com.jianyushanshe.pickerlib.listener.OnItemSelectedListener;
...
//		// 添加联动监听
    ...
    public void setWv_option1IsShow(boolean b) {
        if (wv_option1 != null) {
            wv_option1.setVisibility(b ? View.VISIBLE : View.GONE);
        }
    }
    ...
    public void setWv_option2IsShow(boolean b) {
        if (wv_option2 != null) {
            wv_option2.setVisibility(b ? View.VISIBLE : View.GONE);
        }
    }
    ...
    public void setWv_option3IsShow(boolean b) {
        if (wv_option3 != null) {
            wv_option3.setVisibility(b ? View.VISIBLE : View.GONE);
        }
    }
